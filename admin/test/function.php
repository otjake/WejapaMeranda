...
function post_personal(){
    ...
    $sql="SELECT * FROM posts WHERE `user_id`=$user ORDER BY `date_created` DESC";
    $sql_exec=mysqli_query($conn,$sql);
    return $sql_exec;
...
function admin(){
    global $conn;
    $sql="SELECT * FROM admin ORDER BY `date_created` DESC";
    $sql_exec=mysqli_query($conn,$sql);
    return $sql_exec;
...
function sub(){
    global $conn;
    $sql="SELECT * FROM viewer ORDER BY `date_created` DESC";
    $sql_exec=mysqli_query($conn,$sql);
    return $sql_exec;
